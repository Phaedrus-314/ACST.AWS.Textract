...
namespace AddressParser.Tests
{
    ...
    public class AddressParser_Should
    {
        ...
        {
            var addressParser = new USAddress.AddressParser();
        ...
        public void MatchSecondaryUnitAsWord()
        {
            ...
            var results = streets.Select(s => new { Text = s, Match = Regex.Match(s, USAddress.AddressParser.Default.RangelessSecondaryUnitPattern, USAddress.AddressParser.Default.MatchOptions) });
        ...
        public void ParseExampleAddresses()
        {
            ...
            CombinationApprovals.VerifyAllCombinations(
                Parser.ParseAddress,
                x => Environment.NewLine + ((USAddress.AddressParseResult)x).WritePropertiesToString(),
                examples,
                normalize);
        }
        ...
        {
            Approvals.Verify(USAddress.AddressParser.Default.AllSecondaryUnitPattern);
        }

        [Fact]
        public void VerifyAllUnits()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.AllUnits);
        }

        [Fact]
        public void VerifyCityAndStatePattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.CityAndStatePattern);
        }

        [Fact]
        public void VerifyDirectionalNames()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.DirectionalNames);
        }

        [Fact]
        public void VerifyDirectionalPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.DirectionalPattern);
        }

        [Fact]
        public void VerifyMatchOptions()
        {
            Approvals.Verify(USAddress.AddressParser.Default.MatchOptions);
        }

        [Fact]
        public void VerifyPlacePattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.PlacePattern);
        }

        [Fact]
        public void VerifyPostalBoxPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.PostalBoxPattern);
        }

        [Fact]
        public void VerifyPostalBoxPatternAddressLineOnly()
        {
            Approvals.Verify(USAddress.AddressParser.PostalBoxPatternAddressLineOnly);
        }

        [Fact]
        public void VerifyRangedSecondaryUnitPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.RangedSecondaryUnitPattern);
        }

        [Fact]
        public void VerifyRangedUnits()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.RangedUnits);
        }

        [Fact]
        public void VerifyRangelessSecondaryUnitPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.RangelessSecondaryUnitPattern);
        }

        [Fact]
        public void VerifyRangelessUnits()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.RangelessUnits);
        }

        [Fact]
        public void VerifyStatePattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.StatePattern);
        }

        [Fact]
        public void VerifyStates()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.StatesAndProvinces);
        }

        [Fact]
        public void VerifyStreetPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.StreetPattern);
        }

        [Fact]
        public void VerifySuffixes()
        {
            Approvals.VerifyAll(USAddress.AddressParser.Default.StreetSuffixes);
        }

        [Fact]
        public void VerifySuffixPattern()
        {
            Approvals.Verify(USAddress.AddressParser.Default.SuffixPattern);
        }

        [Fact]
        public void VerifyZipPattern()
        {
            Approvals.Verify(USAddress.AddressParser.ZipPattern);
        }
    }
}